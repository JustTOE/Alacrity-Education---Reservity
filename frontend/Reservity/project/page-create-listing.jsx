/* global React, CampusMap, IsometricRoom, FloorPlanSketch, formatHour, Sparkline */
const { useState: useStateCr, useMemo: useMemoCr, useRef: useRefCr, useEffect: useEffectCr } = React;
...
function CreateListingPage({ data, onNavigate, onToast }) {
