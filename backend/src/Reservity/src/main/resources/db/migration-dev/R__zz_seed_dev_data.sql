...
INSERT INTO users (
    ...
    'user1',
    '$2a$12$dMFog/7GHwEI.3K/row/o.4xDgoiihUXQV4.iLw7xENMMwQ3PPECS',
    'user1',
    'User One (Renter)',
    'U1',
    'REQUESTER',
...
INSERT INTO user_settings (user_id) VALUES ('00000000-0000-0000-0000-000000000002') ON CONFLICT (user_id) DO NOTHING;
...
INSERT INTO users (
    ...
    'user2',
    '$2a$12$uvvD1gJhE9u.FgjB28RhCef5TUKlWSDnScdV5dmLOHKwPnS8gR1Jq',
    'user2',
    'User Two (Creator)',
    'U2',
    'OWNER',
...
INSERT INTO user_settings (user_id) VALUES ('00000000-0000-0000-0000-000000000003') ON CONFLICT (user_id) DO NOTHING;
...
INSERT INTO users (
    ...
    'admin',
    '$2a$12$uUOEGzoCspEjFbNXwKDgv.rvp5S4u9DdyLarEt7hRsFwWLTijBfQC',
    'admin',
    'Admin User',
    'AD',
    'ADMIN',
...
INSERT INTO user_settings (user_id) VALUES ('00000000-0000-0000-0000-000000000004') ON CONFLICT (user_id) DO NOTHING;
